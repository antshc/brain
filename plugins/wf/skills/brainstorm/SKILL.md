...
When you understand the problem, propose 2-3 approaches — with trade-offs and your recommendation.

Ask user to approve the approach before proceeding to the next step.

If user approves, summarize using the format in [BRAINSTORM-FORMAT.md](./BRAINSTORM-FORMAT.md).
