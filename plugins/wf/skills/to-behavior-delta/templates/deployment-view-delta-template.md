...
<!-- Mermaid technical gotchas for C4Container-as-deployment (consistent with the class/flowchart delta conventions):
...
<!-- Replace every alias, label, technology, and relationship below with the real deployment delta. Add or remove Container_Boundary/Boundary/Container/ContainerDb/Rel lines to match actual scope; do not keep unused example elements. -->
...
C4Container
    ...
    Container_Boundary({{removedNodeAlias}}, "{{removedNodeLabel}}") {
