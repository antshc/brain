...
| Swimlane diagram delta | Cross-boundary process flow where ownership is the decision — Level 1 lanes are containers, Level 2 lanes are components/modules inside one container | [swimlane-diagram-delta-template.md](templates/swimlane-diagram-delta-template.md) |
