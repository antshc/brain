...
- Every requirement is **solution-agnostic** — swapping UI or technology would not force a reword. Run `/normalize-requirements` skill to check **capability title**, **functional requirements**, **business rules**, and **edge cases** are **solution-agnostic**.
