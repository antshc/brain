...
1. Explore the repo to understand the current state of the codebase, if you haven't already. If `grill-design` ran, use the project's domain glossary vocabulary throughout the PRD and respect any ADRs in the area you're touching.
