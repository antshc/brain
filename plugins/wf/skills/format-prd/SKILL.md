---
name: format-prd
description: Format, update, or rewrite a PRD document. Use when user wants to format a PRD, update a PRD, change a PRD while preserving structure, or ensure PRD consistency.
argument-hint: '<prd content or issue reference>'
---

This skill enforces the canonical PRD format. Use it when updating, reformatting, or rewriting a PRD to keep the document compressed and structurally consistent.
