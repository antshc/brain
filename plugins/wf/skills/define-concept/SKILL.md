...
Own the concept's scope and decisions. `/questioning` owns the interview; `/doc-concept` renders the body; `/record-concept` owns persistence and indexing. Do not reimplement their rules.
