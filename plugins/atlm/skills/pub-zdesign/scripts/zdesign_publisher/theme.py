"""Recolors zdesign diagrams' dark-theme hex codes to the style1-github-light palette
before rendering. Pure string substitution — the source markdown is never touched, only
the throwaway `.mmd` written to the assets dir at render time.
"""
from __future__ import annotations

# 1:1 hex swap covering every color used by the dark-theme diagrams in docs/designs-styles.md
# and the to-zdesign templates (fill/stroke/text/added/removed/person-accent).
