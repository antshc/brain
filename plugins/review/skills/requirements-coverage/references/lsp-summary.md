...
- **Fan-out** — how many files and callers the symbol reaches.
- **Callers (representative)** — trace whether the changed behavior is actually wired to its callers (key for confirming a requirement is truly implemented, not just declared).
