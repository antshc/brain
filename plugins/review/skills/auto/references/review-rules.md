...
- Ground conclusions on sufficient and relevant repository-wide evidence gathered via the shared LSP summary and `<skill-directory>/references/lsp-analysis.md`, not on the patch alone and not on exhaustive exploration.
