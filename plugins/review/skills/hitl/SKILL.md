...
5. Explore code if needed — if the issue depends on external context, run `/lsp-depth-navigation` skill to inspect related code, usages, or callers before commenting; otherwise rely on the provided snippet.
