...
5. Explore code if needed — if the issue depends on external context, use `<skill-directory>/references/lsp-analysis.md` to inspect related code, usages, or callers before commenting; otherwise rely on the provided snippet.
